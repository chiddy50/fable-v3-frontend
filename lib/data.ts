...
export const hairQuirks = [
    "Unruly or unmanageable hair",
    "Split ends",
    "Balding or thinning",
    "A single stray hair that always seems to stick up",
    "A habit of playing with or twirling their hair",
    "No Quirks",
];
...
export const intelligenceOptions = [
    ...
    "Skilled researcher",
    "Adept at puzzles and brain teasers",
    "Talented at solving complex problems",
    "Innovative thinker",
    "Visionary",
];
