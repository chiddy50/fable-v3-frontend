...
interface ImageUploaderProps {
	...
	// setImageSignature?: (signature: string) => void;

	setImagePublicId: React.Dispatch<React.SetStateAction<string>>;      
	setImageSignature: React.Dispatch<React.SetStateAction<string>>;      

}

export default function ImageUploader({ articleId, setImageId, setImagePublicId, setImageSignature }: ImageUploaderProps) {
