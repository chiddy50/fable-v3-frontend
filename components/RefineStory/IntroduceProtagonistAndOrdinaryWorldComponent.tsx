...
const IntroduceProtagonistAndOrdinaryWorldComponent: React.FC<IntroduceProtagonistAndOrdinaryWorldComponentProps> = ({
    ...
    const saveGeneration = async () => {
        if (introduceProtagonistAndOrdinaryWorld) {                
            // save data
            let updated = await makeRequest({
    ...
    return (
        <div className="my-10 bg-gray-50 p-5 rounded-2xl">
            ...
            <Sheet open={modifyModalOpen} onOpenChange={setModifyModalOpen}>
                <SheetContent 
                    // side="bottom" 
                    className="overflow-y-scroll xs:min-w-[90%] sm:min-w-[96%] md:min-w-[65%] lg:min-w-[65%] xl:min-w-[55%]">
                    ...
                    <div className='mt-5'>
                        ...
                        <div className="mb-4">
                            <Button size="sm"  
                            className='flex items-center gap-2 w-full bg-custom_green'
